import{S as Ee,i as Be,s as Se,N,e as r,w as v,b as k,c as Ce,f as b,g as d,h as n,m as ye,x as O,P as ve,Q as Me,k as Re,R as Ae,n as Ue,t as ee,a as te,o as m,d as Te,U as We,C as ze,p as He,r as F,u as je,M as De}from"./index-d13eef24.js";import{S as Le}from"./SdkTabs-f13488d2.js";function we(o,l,a){const s=o.slice();return s[5]=l[a],s}function $e(o,l,a){const s=o.slice();return s[5]=l[a],s}function qe(o,l){let a,s=l[5].code+"",h,f,i,p;function u(){return l[4](l[5])}return{key:o,first:null,c(){a=r("button"),h=v(s),f=k(),b(a,"class","tab-item"),F(a,"active",l[1]===l[5].code),this.first=a},m($,q){d($,a,q),n(a,h),n(a,f),i||(p=je(a,"click",u),i=!0)},p($,q){l=$,q&4&&s!==(s=l[5].code+"")&&O(h,s),q&6&&F(a,"active",l[1]===l[5].code)},d($){$&&m(a),i=!1,p()}}}function Pe(o,l){let a,s,h,f;return s=new De({props:{content:l[5].body}}),{key:o,first:null,c(){a=r("div"),Ce(s.$$.fragment),h=k(),b(a,"class","tab-item"),F(a,"active",l[1]===l[5].code),this.first=a},m(i,p){d(i,a,p),ye(s,a,null),n(a,h),f=!0},p(i,p){l=i;const u={};p&4&&(u.content=l[5].body),s.$set(u),(!f||p&6)&&F(a,"active",l[1]===l[5].code)},i(i){f||(ee(s.$$.fragment,i),f=!0)},o(i){te(s.$$.fragment,i),f=!1},d(i){i&&m(a),Te(s)}}}function Ne(o){var pe,ue,be,fe;let l,a,s=o[0].name+"",h,f,i,p,u,$,q,W=o[0].name+"",I,le,K,P,Q,T,G,w,z,ae,H,E,se,J,j=o[0].name+"",V,oe,ne,D,X,B,Y,S,Z,M,x,C,R,g=[],ie=new Map,ce,A,_=[],re=new Map,y;P=new Le({props:{js:`
