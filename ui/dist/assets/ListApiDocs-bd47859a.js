import{S as Xe,i as Ye,s as Ze,e,b as n,E as el,f as a,g as u,u as tl,y as Be,o as m,w as _,h as t,M as ye,N as Zt,c as te,m as ee,x as Ce,P as Ge,Q as ll,k as nl,R as sl,n as ol,t as Bt,a as Gt,d as le,T as al,U as il,C as ke,p as rl,r as ve}from"./index-d13eef24.js";import{S as cl}from"./SdkTabs-f13488d2.js";function dl(d){let s,o,i;return{c(){s=e("span"),s.textContent="Show details",o=n(),i=e("i"),a(s,"class","txt"),a(i,"class","ri-arrow-down-s-line")},m(f,h){u(f,s,h),u(f,o,h),u(f,i,h)},d(f){f&&(m(s),m(o),m(i))}}}function pl(d){let s,o,i;return{c(){s=e("span"),s.textContent="Hide details",o=n(),i=e("i"),a(s,"class","txt"),a(i,"class","ri-arrow-up-s-line")},m(f,h){u(f,s,h),u(f,o,h),u(f,i,h)},d(f){f&&(m(s),m(o),m(i))}}}function Ue(d){let s,o,i,f,h,r,b,C,$,g,p,Z,Ct,Ut,O,jt,H,it,R,tt,ne,U,j,se,rt,$t,et,kt,oe,ct,dt,lt,E,Jt,yt,F,nt,vt,Qt,Ft,J,st,Lt,zt,At,A,pt,Tt,ae,ft,ie,D,Pt,ot,Rt,S,ut,re,Q,St,Kt,Ot,ce,N,Vt,z,mt,de,I,pe,B,fe,T,Et,K,ht,ue,bt,me,w,Nt,at,qt,he,Mt,Wt,V,gt,be,Ht,ge,_t,_e,W,xt,Xt,X,Yt,q,wt,y,Dt,xe,Y,L,It,G,v;return{c(){s=e("p"),s.innerHTML=`The syntax basically follows the format
